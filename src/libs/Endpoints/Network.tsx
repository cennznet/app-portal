...
function NetworkDisplay({
	...
	className = "",
	setApiUrl,
	value: { icon, isChild, isUnreachable, name, providers },
	...
	const _selectUrl = useCallback(() => {
		...
		return setApiUrl(
			name,
			filteredProviders[Math.floor(Math.random() * filteredProviders.length)]
				.url
		);
	...
	return (
		<div
			className={`${className}${
				isSelected ? " isSelected highlight--border" : ""
