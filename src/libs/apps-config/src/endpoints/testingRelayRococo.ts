	...
	return {
		...
		linked: [
			...
			},
			{
				...
				paraId: 1003,
				text: t("rpc.rococo.encointer", "Encointer Lietaer", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				info: "rococoGenshiro",
				paraId: 2024,
				text: t("rpc.rococo.genshiro", "Genshiro Rococo Testnet", {
					ns: "apps-config",
				}),
				providers: {
					Equilibrium:
			...
			},
			{
				...
				paraId: 3002,
				text: t("rpc.rococo.integritee", "Integritee Network", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				info: "rococoTinker",
				paraId: 2014,
				text: t("rpc.rococo.tinker", "InvArch Tinkernet", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				info: "rococoPangolin",
				paraId: 2105,
				text: t("rpc.rococo.pangolin", "Pangolin Parachain", {
					ns: "apps-config",
				}),
				providers: {
