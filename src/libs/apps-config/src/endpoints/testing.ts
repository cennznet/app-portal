	...
	return expandEndpoints(
		...
		[
			...
			},
			{
				...
				text: t("rpc.test.automata-contextfree", "Automata ContextFree", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "bifrost",
				text: t("rpc.test.bifrost", "Bifrost Stage Network", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "bitcountry",
				text: t("rpc.test.bitcountry", "Bit.Country - Metaverse Network", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.coinversation", "Coinversation", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.creditcoin", "Creditcoin Testnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "Crust Maxwell",
				text: t("rpc.test.crust.network", "Crust Maxwell", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				info: "datahighway",
				isDisabled: true,
				text: t("rpc.test.datahighway.spreehafen", "Spreehafen", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "encointer",
				text: t("rpc.test.encointer.gesell", "Encointer Gesell", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.equilibriumtestnet", "Equilibrium", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.halongbay", "Halongbay Testnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				info: "kylin",
				isDisabled: true, // https://github.com/polkadot-js/apps/issues/6635
				text: t("testnet.kylin-node.co.uk", "Kylin Testnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.kylin-node.co.uk", "Pichiu Testnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.sora-substrate-staging", "SORA-staging", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.test.subspace.farmnet", "Subspace Farmnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "ternoa-testnet",
				text: t("rpc.test.ternoa-testnet", "Ternoa Testnet", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "zeitgeist",
				text: t("rpc.test.zeitgeist", "Zeitgeist Battery Station", {
					ns: "apps-config",
				}),
				providers: {
