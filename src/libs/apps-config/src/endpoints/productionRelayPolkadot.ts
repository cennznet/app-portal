	...
	return {
		...
		linked: [
			...
			},
			{
				...
				paraId: 2027,
				text: t("rpc.polkadot.coinversation", "Coinversation", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				paraId: 2019,
				text: t("rpc.polkadot.composable", "Composable Finance", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				paraId: 2011,
				text: t("rpc.polkadot.equilibrium", "Equilibrium", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				isUnreachable: true,
				text: t("rpc.polkadot.origintrail", "OriginTrail Parachain", {
					ns: "apps-config",
				}),
				paraId: 2043,
				providers: {
