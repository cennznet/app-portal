	...
	return expandEndpoints(
		...
		[
			...
			},
			{
				dnslink: "centrifuge",
				info: "centrifuge",
				text: t("rpc.prod.centrifuge", "Centrifuge Standalone [Archived]", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.prod.coinversation", "Coinversation", {
					ns: "apps-config",
				}),
				providers: {
			...
			},
			{
				...
				text: t("rpc.prod.competitors-club", "Competitors Club", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "crown-sterling",
				text: t("rpc.prod.crown-sterling", "Crown Sterling", {
					ns: "apps-config",
				}),
				providers: {
			...
			{
				info: "integritee",
				text: t("rpc.prod.integritee", "Integritee Network", {
					ns: "apps-config",
				}),
				providers: {
